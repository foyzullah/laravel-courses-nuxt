...
const course = await $fetch(`http://localhost/laravel-courses/public/api/course/${route.params.id}`);
                ...
                <ol role="list" class="flex items-center space-x-0.5">
                  ...
                  <li>
                    <div class="flex items-center">
                      ...
                      <div class="-m-1" href="#">
                        <a href="#" class="p-1 ml-0.5 text-base font-medium text-gray-400 rounded-md focus:outline-none focus:ring-2 focus:text-gray-900 focus:ring-gray-900 hover:text-gray-700"> {{course.series.name}} </a>
                      </div>
                    </div>
                  </li>
                </ol>
            ...
            <div class="flex mt-8">
                ...
                <div class="mt-2 w-2/3 border-gray-100 border-r pr-10 pb-0 border-b-0">
                  ...
                  <div class="rounded-sm mt-8 shadow-sm bg-white">
                    <img :src="course.image" class="w-full" alt="Testing Laravel">
                    <div class="p-6">
                ...
                <div class="w-1/3 pl-10 pt-0">
                  ...
                  <div class="overflow-hidden bg-white border border-gray-200 rounded-sm shadow-sm">
                    <div class="space-y-4 p-6">
                      ...
                      <div v-for="author in course.authors" class="space-y-4 pb-2">
                        <div class="aspect-w-3 aspect-h-2">
                          <img class="object-cover w-48 m-auto shadow" src="https://laravel-courses.com/storage/thumbnails/default/9d/ke/1lin0xkwk00s888k8wc48.png?p=authors%2F04ff15e2-69b1-4110-a7a8-0ec15616abaf.png&amp;s=pd&amp;widen=200" :alt="author.name">
                        </div>
                  ...
                  <div class="overflow-hidden bg-white border border-gray-200 rounded-sm mt-6 shadow-sm">
                    <div class="px-4 py-5 sm:p-6">
                      ...
                      <div class="mt-8 flex flex-wrap gap-2.5">
                        <a v-for="topic in course.topics" href="#" class="relative inline-flex items-center rounded-full border border-gray-300 px-3 py-1.5 hover:bg-gray-100">

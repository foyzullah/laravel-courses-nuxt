    ...
    <header class="flex text-white h-16 justify-between items-center">
                <div class="flex items-center">
                    ...
                    <nav class="hidden h-16 space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <a href="courses" class="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-base font-medium leading-5 text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition">Courses</a>
                ...
                <!--Signup login and search button-->
                <div class="flex items-center">
                    <div class="flex flex-1 items-center px-2 mr-6 justify-end">
                        <form action="" method="GET">
                          <div class="w-full first-letter:max-w-xs">
